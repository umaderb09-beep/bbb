...
export function TournamentRegistration({ tournament, onClose, onSubmit }: TournamentRegistrationProps) {
  ...
  const loadPreset = (presetId: string) => {
    ...
    if (preset) {
      const presetBeyblades = preset.beyblades.slice(0, tournament.beyblades_per_player).map((bey: any, index: number) => ({
        id: (index + 1).toString(),
            ...
            <div className="mb-8 bg-green-50 border border-green-200 rounded-lg p-6">
              ...
              <div className="mb-4 p-3 bg-white rounded-lg border border-green-200">
                <p className="text-sm text-green-800">
                  <strong>Save time!</strong> Use one of your saved deck presets to quickly configure your Beyblades for this tournament.
                </p>
              </div>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
